class SpotsController < ApplicationController
  ...
  def index
    ...
    if params["selected-wing-sizes"] == "" && params["selected-wing-sizes-index"] == ""
      params["selected-wing-sizes"] = nil
    elsif params["selected-wing-sizes"] == "" && params["selected-wing-sizes-index"] != ""
      params["selected-wing-sizes"] = params["selected-wing-sizes-index"]
    end
    ...
    @condition_string = { "clear-day" => "Beau temps", "clear-night" => "Nuit claire", "rain" => "Pluie", "snow" => "Neige", "sleet" => "Neige fondue", "wind" => "Venteux", "fog" => "Brouillard", "cloudy" => "Nuageux", "partly-cloudy-day" => "Partiellement nuageux", "partly-cloudy-night" => "Nuit partiellement nuageuse" }
  end
